<%@ page language="C#" masterpagefile="~/MasterPages/ProperDevMasterPage.master" autoeventwireup="true" inherits="MenuCategory, mybuylist" title="<%$ Resources:MyGlobalResources, CategoryEdition%>" theme="Standard" %>
    ...
    <table width="100%">
        <tr>
            <td style="width: 200px; height: 26px;" valign="top">
                <asp:Label ID="lblCategoryName" runat="server" Font-Bold="true" Text='<%$ Resources:MyGlobalResources, MenuCategory%>'></asp:Label>
            </td>
        ...
        <tr>
            <td colspan="3">
                ...
                <asp:Button ID="btnCancel" runat="server" Text='<%$ Resources:MyGlobalResources, Cancel%>'
                    CausesValidation="false" PostBackUrl="~/Admin/MenuCategoriesList.aspx" />&nbsp;&nbsp;
