<%@ page language="C#" masterpagefile="~/MasterPages/ProperDevMasterPage.master" autoeventwireup="true" inherits="MenuCategoriesList, mybuylist" title="<%$ Resources:MyGlobalResources, Categories %>" theme="Standard" %>
                        ...
                        <table>
                            <tr>
                                <td style="width: 440px">
                                    <asp:Label ID="lblTitle" runat="server" Font-Bold="true" Text="<%$ Resources:MyGlobalResources, MenuCategories %>"></asp:Label>
                                </td>
                                <td>
                ...
                <tr>
                    <td>
                        <asp:Button ID="btnAdd" runat="server" Text="<%$ Resources:MyGlobalResources, Add %>"
                            PostBackUrl="~/Admin/MenuCategory.aspx" />
                    </td>
                </tr>
            </table>
        </ContentTemplate>
