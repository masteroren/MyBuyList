<%@ page language="C#" masterpagefile="~/MasterPages/ProperDevMasterPage.master" autoeventwireup="true" inherits="PageShopDepartment, mybuylist" title="<%$ Resources:MyGlobalResources, DepartmentEdition%>" theme="Standard" %>
