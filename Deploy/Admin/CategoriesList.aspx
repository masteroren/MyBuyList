<%@ page language="C#" masterpagefile="~/MasterPages/ProperDevMasterPage.master" autoeventwireup="true" inherits="PageCategoriesList, mybuylist" title="<%$ Resources:MyGlobalResources, Categories %>" theme="Standard" %>
