<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ScreenShotRecipe.aspx.cs"
    Inherits="ScreenShotRecipe" ValidateRequest="false" %>
...
<body>
    ...
    <div dir="rtl" id="printPage_main" style="width: 800px">
        ...
        <div id="recipe_instructions">
            ...
            <asp:Label ID="txtPreparationMethod" runat="server" Font-Size="16px"></asp:Label>
        </div>
