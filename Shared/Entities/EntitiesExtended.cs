    ...
    public partial class Ingredient
    {
        ...
        public string DISPLAY_NAME
        {
            get
            {
                ...
                string[] arr = this.Quantity.ToString().Split(new string[] { ".", "," }, StringSplitOptions.RemoveEmptyEntries);
                if (arr.Length > 0)
                {
                    if (arr[0] != "0")
                ...
                return string.Format("{0} {1} {2} {3}", displayQuantity,
                                     this.MeasurementUnit.UnitName,
                                     this.Food.FoodName, string.IsNullOrEmpty(this.Remarks) ? "" : this.Remarks);
            }
